package com.example.lenovo.alertdialog;
...
import com.example.lenovo.alertdialog.R;
...
public class AlertDialogDemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tView=(TextView) this.findViewById(R.id.button1);
    ...
    private void dialog4() {
        ...
        DialogInterface.OnMultiChoiceClickListener mListennter=new DialogInterface.OnMultiChoiceClickListener(){
        ...
        builder.setMultiChoiceItems(item,null,mListennter);
        dialog.setTitle("复选框");
        DialogInterface.OnClickListener listenter=new DialogInterface.OnClickListener(){
